...
type ReleaseRelease struct {
	...
	// FIXME Config is the set of extra Values added to the chart. These values override the default values inside of the chart.
	Config map[string]string `json:"config,omitempty"`
	//Config map[string]ErrorUnknown `json:"config,omitempty"`
