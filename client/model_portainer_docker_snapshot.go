...
type PortainerDockerSnapshot struct {
	...
	HealthyContainerCount   int32                       `json:"HealthyContainerCount,omitempty"`
	...
	StackCount              int32                       `json:"StackCount,omitempty"`
	...
	UnhealthyContainerCount int32                       `json:"UnhealthyContainerCount,omitempty"`
